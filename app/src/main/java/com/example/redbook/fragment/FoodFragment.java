...
import com.example.redbook.databinding.FragmentFoodBinding;
...
public class FoodFragment extends BaseFragment implements IDongmanListener {
    ...
    protected void setDataBinding(ViewDataBinding dataBinding) {
        binding = (FragmentFoodBinding) dataBinding;
    }
    ...
    protected void initListener() {
        dongmanAdapter.setNewData(Utils.getFoodList());
