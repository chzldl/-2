...
import com.example.redbook.databinding.FragmentGameBinding;
...
public class GameFragment extends BaseFragment implements IDongmanListener {
    ...
    protected void setDataBinding(ViewDataBinding dataBinding) {
        binding = (FragmentGameBinding) dataBinding;
    }
    ...
    protected void initListener() {
        ...
        dongmanAdapter.setNewData(Utils.getGameList());
